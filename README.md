# Rock5b使用meizu-e3-1080x2160-6英寸-60Hz
...
```
sudo apt-get install -y git make gcc g++ gettext
```
...
在 rock-5b-meizu-e3-1080x2160-6inch-60hz.dts 目录下执行 sudo rsetup  -> Overlays -> Install 3rd party overlay -> rock-5b-meizu-e3-1080x2160-6inch-60hz.dts 回车。
...
cpp -nostdinc \
  ...
  rock-5b-meizu-e3-1080x2160-6inch-60hz.dts > rock-5b-radxa-display-meizu-e3-6inch-gen.dts
```
